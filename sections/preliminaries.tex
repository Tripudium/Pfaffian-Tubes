...
The following result is a variant of~\cite[Corollary 3.3]{gabrielov2004complexity} and~\cite[Theorem 2.3]{jones2012density}, using the refined bound of Theorem~\ref{thm:khovanskii}; the refinement is advantageous when the Pfaffian chain is short ($s<n$) or depends on few of the variables ($k<n$).
