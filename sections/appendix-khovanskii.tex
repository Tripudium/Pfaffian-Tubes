...
We give a self-contained proof of Khovanskii's Theorem (Theorem \ref{thm:khovanskii}).
The two main ingredients of the proof are B\'ezout's Inequality for real algebraic sets, Theorem~\ref{thm:real-bezout}, and a generalisation of Rolle's Theorem~\cite[\S 3.2]{khovanskii1991fewnomials}.
...
For an illustration of the following generalisation of Rolle's Lemma, see~\cite{bates2011khovanskii}.
...
\begin{lemma}[Khovanskii-Rolle] \label{lem:kho-rolle}
...
The following technical lemma, which bounds the degree of the determinant arising in the Khovanskii--Rolle step, is the key ingredient in the induction.
...
\medskip
\noindent\textbf{Step 2: Applying the Khovanskii--Rolle Corollary.}
